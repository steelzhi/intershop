...
public class ItemControllerWebLayerTest {
    ...
    @Test
    void decreaseItemAmountOnMainPage_shouldReturnItemWithAmountDecreased() throws Exception {
        ItemDto itemDto1 = new ItemDto("DE", "zzz", null, 11.0, 2);
        itemDto1.setId(1);
    ...
    @Test
    void increaseItemAmountOnMainPage_shouldReturnItemWithAmountIncreased() throws Exception {
        ItemDto itemDto1 = new ItemDto("DE", "zzz", null, 11.0, 2);
        itemDto1.setId(1);
